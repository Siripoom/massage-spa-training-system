...
const CourseContentManager = ({ modules, onModulesChange })=>{
    ...
    const collapseItems = modules.map((module, moduleIndex)=>({
            ...
            children: // Removed <Form> component here to avoid nesting forms
                ...
                children: [
                    ...
                    module.contents.map((item, itemIndex)=>{
                        ...
                        const editor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tiptap$2f$react$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useEditor"])({
                            ...
                            onUpdate: ({ editor })=>{
                                updateContentItem(module.id, item.id, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b6acacb._.js.map