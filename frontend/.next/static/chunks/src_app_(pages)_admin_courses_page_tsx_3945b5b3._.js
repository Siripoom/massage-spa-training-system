...
function CoursesPage() {
    ...
    const [hasLoadedCourses, setHasLoadedCourses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // State for hydration
    // Load courses from localStorage on component mount
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursesPage.useEffect": ()=>{
            const loadCourses = {
                "CoursesPage.useEffect.loadCourses": ()=>{
                    try {
            ...
            const handleStorageChange = {
                "CoursesPage.useEffect.handleStorageChange": (event)=>{
                    if (event.key === 'courses') {
                        loadCourses();
                    }
                }
            }["CoursesPage.useEffect.handleStorageChange"];
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$modal$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Modal$3e$__["Modal"].confirm({
            ...
            onOk () {
                setCourses((prevCourses)=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success('ลบหลักสูตรเรียบร้อยแล้ว!');
    ...
    const filteredCourses = courses.filter((course)=>course.courseName.toLowerCase().includes(searchTerm.toLowerCase()) || course.description.toLowerCase().includes(searchTerm.toLowerCase()));
    const columns = [
        {
            title: '#',
        ...
        },
        {
            ...
            dataIndex: 'price',
            key: 'price',
            render: (price)=>`${price.toFixed(2)} บาท`,
            className: 'text-gray-700'
        },
        {
            title: 'ระยะเวลา',
            ...
            key: 'durationHours',
            render: (duration)=>`${duration} ชั่วโมง`,
            className: 'text-gray-700'
        },
        {
            title: 'สร้างเมื่อ',
    ...
    const modalCollapseItems = viewingCourse?.modules.map((module)=>({
            key: module.id,
            label: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Text, {
                strong: true,
            ...
            children: module.contents.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Text, {
                type: "secondary",
                children: "ไม่มีเนื้อหาในโมดูลนี้"
            }, void 0, false, {
                fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                lineNumber: 192,
                columnNumber: 9
                ...
                direction: "vertical",
                className: "w-full",
                children: module.contents.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$card$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Card$3e$__["Card"], {
                        size: "small",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        " ",
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(viewingCourse.createdAt).format('DD/MM/YYYY, HH:mm')
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                                    lineNumber: 267,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        ...
                                        " ",
                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dayjs$2f$dayjs$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(viewingCourse.updatedAt).format('DD/MM/YYYY, HH:mm')
                                    ]
                                }, void 0, true, {
                                    fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                                    lineNumber: 268,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AntdTitle, {
                                    level: 5,
                                    className: "mt-6 mb-4 text-gray-700",
                                    children: "เนื้อหาหลักสูตร"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                                    lineNumber: 270,
                                    columnNumber: 15
                                }, this),
                                viewingCourse.modules.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Text, {
                                    type: "secondary",
                                    children: "ไม่มีเนื้อหาในหลักสูตรนี้"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                                    lineNumber: 272,
                                    columnNumber: 17
                                }, this) : // Use items prop here as well
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$collapse$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Collapse$3e$__["Collapse"], {
                                    accordion: true,
                                    className: "rounded-lg shadow-sm",
                                    items: modalCollapseItems
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(pages)/admin/courses/page.tsx",
                                    lineNumber: 275,
                                    columnNumber: 17
...
_s(CoursesPage, "KlsRzxDt2CZOYz6HK/PEDfAzwiM=", false, function() {
    return [
