        ...
        assignments: [
            {
                ...
                courseId: 'course-1',
                courseName: 'หลักสูตรการนวดแผนไทยพื้นฐาน',
                dueDate: new Date(baseTime + 3 * 24 * 60 * 60 * 1000).toISOString(),
                submitted: 18,
                total: 25,
                status: 'pending'
            },
            {
                ...
                courseId: 'course-2',
                courseName: 'หลักสูตรการนวดอโรม่า',
                dueDate: new Date(baseTime + 7 * 24 * 60 * 60 * 1000).toISOString(),
                submitted: 12,
                total: 18,
                status: 'grading'
            }
        ...
        recentActivities: [
            {
                ...
                time: new Date(baseTime - 30 * 60 * 1000).toISOString(),
            ...
            },
            {
                ...
                time: new Date(baseTime - 2 * 60 * 60 * 1000).toISOString(),
            ...
            },
            {
                ...
                time: new Date(baseTime - 4 * 60 * 60 * 1000).toISOString(),
                courseName: 'หลักสูตรการนวดอโรม่า'
            }
        ]
    };
...
function TeacherDashboardPage() {
    ...
    const handleViewCourse = (courseId)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ดูรายละเอียดหลักสูตร: ${course.courseName}`);
            console.log('View course:', courseId);
        // TODO: Navigate to course details page
        // router.push(`/teacher/courses/${courseId}`);
        } catch (error) {
            console.error('Error viewing course:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการดูรายละเอียดหลักสูตร');
        }
    };
    const handleViewStudent = (studentId)=>{
        try {
            if (!studentId || studentId.trim() === '') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('รหัสนักเรียนไม่ถูกต้อง');
                return;
            }
            const student = students.find((s)=>s.id === studentId);
            if (!student) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('ไม่พบนักเรียนที่เลือก');
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ดูข้อมูลนักเรียน: ${student.firstName} ${student.lastName}`);
            console.log('View student:', studentId);
        // TODO: Navigate to student details page
        // router.push(`/teacher/students/${studentId}`);
        } catch (error) {
            console.error('Error viewing student:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการดูข้อมูลนักเรียน');
        }
    };
    const handleGradeAssignment = (assignmentId)=>{
        try {
            if (!assignmentId || assignmentId.trim() === '') {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('รหัสงานไม่ถูกต้อง');
                return;
            }
            const assignment = assignments.find((a)=>a.id === assignmentId);
            if (!assignment) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('ไม่พบงานที่เลือก');
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ตรวจงาน: ${assignment.title}`);
        ...
        // router.push(`/teacher/assignments/${assignmentId}/grade`);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการตรวจงาน');
        }
    };
    const handleViewAllCourses = ()=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info('กำลังไปยังหน้าหลักสูตรทั้งหมด...');
        // TODO: Navigate to all courses page
        // router.push('/teacher/courses');
        } catch (error) {
            console.error('Error navigating to courses:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการเปิดหน้าหลักสูตร');
        }
    };
    const handleViewAllActivities = ()=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info('กำลังไปยังหน้ากิจกรรมทั้งหมด...');
        // TODO: Navigate to all activities page
        // router.push('/teacher/activities');
        } catch (error) {
            console.error('Error navigating to activities:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการเปิดหน้ากิจกรรม');
        }
    };
    const handleViewAllStudents = ()=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info('กำลังไปยังหน้านักเรียนทั้งหมด...');
        // TODO: Navigate to all students page
        // router.push('/teacher/students');
        } catch (error) {
            console.error('Error navigating to students:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการเปิดหน้านักเรียน');
        }
    };
    const handleViewAllAssignments = ()=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info('กำลังไปยังหน้างานทั้งหมด...');
        // TODO: Navigate to all assignments page
        // router.push('/teacher/assignments');
        } catch (error) {
            console.error('Error navigating to assignments:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('เกิดข้อผิดพลาดในการเปิดหน้างาน');
        }
    };
...
_s(TeacherDashboardPage, "cdCj6nHf2B9LpDZp5m/4cYBOu5I=");
