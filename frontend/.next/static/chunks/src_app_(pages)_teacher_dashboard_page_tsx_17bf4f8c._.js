...
function TeacherDashboardPage() {
    ...
    const handleViewCourse = (courseId)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ดูรายละเอียดหลักสูตร: ${courseId}`);
        console.log('View course:', courseId);
    };
    const handleViewStudent = (studentId)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ดูข้อมูลนักเรียน: ${studentId}`);
        console.log('View student:', studentId);
    };
    const handleGradeAssignment = (assignmentId)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].info(`ตรวจงาน: ${assignmentId}`);
